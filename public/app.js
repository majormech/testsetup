...
const APP_PAGE_PATHS = {
  ...
  '/search.html': 'search',
  '/request-ST01.html': 'request-st01',
  '/request-ST02.html': 'request-st02',
  '/request-ST03.html': 'request-st03',
  '/request-ST04.html': 'request-st04',
  '/request-ST05.html': 'request-st05',
  '/request-ST06.html': 'request-st06',
  '/request-ST07.html': 'request-st07',
};
...
async function wireEnhancedAdminPage() {
  ...
  async function loadAdminData() {
    try {
      ...
      await Promise.all([loadSettings(), loadErrors(), loadUsers()]);
    } catch (error) {
  ...
  refreshButton?.addEventListener('click', async () => {
    try {
      await Promise.all([loadErrors(), loadUsers()]);
